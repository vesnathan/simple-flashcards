          ...
          PolicyDocument: JSON.stringify({
            ...
            Statement: [
              ...
              },
              {
                ...
                Resource: [
                  `arn:aws:logs:${CONFIG.REGION}:${CONFIG.ACCOUNT_ID}:log-group:/aws/lambda/flashcards-${CONFIG.STAGE}-*:*`,
                  `arn:aws:logs:${CONFIG.REGION}:${CONFIG.ACCOUNT_ID}:log-group:/aws/lambda/flashcards-${CONFIG.STAGE}-*:*:*`,
                  `arn:aws:logs:${CONFIG.REGION}:${CONFIG.ACCOUNT_ID}:log-group:/aws/apigateway/flashcards-${CONFIG.STAGE}-*:*`,
                  `arn:aws:logs:${CONFIG.REGION}:${CONFIG.ACCOUNT_ID}:log-group:/aws/apigateway/*`,
                ],
              },
            ],
          }),
